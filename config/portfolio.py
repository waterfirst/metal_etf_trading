...
# ============================================================
# 연금저축 CMA 적립식 ETF모으기 설정 (2026-03-31 확인)
# 기간: 2021-04-01 ~ 2026-03-31 (⚠️ 만료 임박 - 갱신 필요)
# ============================================================
PENSION_DCA_SCHEDULE = {
    "account": "7156074820-15",
    "total_weekly": 2_000_000,
    "start_date": "2021-04-01",
    "end_date": "2026-03-31",
    "items": [
        {"name": "KODEX 증권", "amount": 500_000, "day": "화", "time": "시장가"},
        {"name": "KODEX 미국AI전력핵심인프라", "amount": 500_000, "day": "목", "time": "시장가"},
        {"name": "KODEX 200", "amount": 500_000, "day": "목", "time": "시장가"},
        {"name": "ACE 구글밸류체인액티브", "amount": 500_000, "day": "목", "time": "시장가"},
    ],
}
